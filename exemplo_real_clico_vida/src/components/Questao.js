...
export default class Questao extends React.Component {
    render() {
        return (
            <>
                <h1>Are you really a true fan of Star Wars? Prove yourself!!</h1>
                <h2>Question {this.props.currentQuestion + 1}</h2>
                <img alt='img' src={this.props.images[Questions.questions[this.props.currentQuestion].question_image].default} />
